...
.twPc-StatLabel {
 ...
 <div class="breadcrumb-banner-area pt-94 pb-85 bg-3 bg-opacity-dark-blue-90" data-aos="zoom-in-up">
                    <div class="container">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="breadcrumb-text">
                                    <h2 class="text-center text-white uppercase mb-17">our services</h2>
                                    <div class="breadcrumb-bar">
                                        <ul class="breadcrumb text-center m-0">
                                            <li class="text-white uppercase ml-15 mr-15"><a href="index.html">Home</a></li>
                                            <li class="text-white uppercase ml-15 mr-15">our services</li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                                ...
                                <!--Start of Blog Area-->
                <div class="blog-area pt-80 pb-11">
                    <div class="container">
                      <div class="row">
                            <div class="col-md-12" data-aos="flip-down">
                                <div class="section-title text-center ">
                                    <h2 class="uppercase">what we offer you</h2>
                       ...
                       <div class="contact-info text-center fix pt-100 pb-115">
                            <div class="single-contact-info" >
                              ...
                              <div class="col-md-10" data-aos="zoom-in-up">
                                 <h4 style="float: left">Background screening</h4>
                                <div class="single-contact-text mt-18">
                                  <p style="float: left;text-align: left;
  text-justify: inter-word;">Short explaination Establish and professionally manage a common database to share information on the credit payment behavior of borrowers.</p>
                            ...
                            <div class="single-contact-info">
                              ...
                              <div class="col-md-10" data-aos="zoom-in-down">
                                 <h4 style="float: left">Temporary staffing</h4>
                            ...
                            <div class="single-contact-info">
                             <div class="col-md-2" data-aos="flip-up">
                              ...
                              <div class="col-md-10" data-aos="zoom-in-right">
                                <h4  style="float: left" >Permanent staffing</h4>
                                <div class="single-contact-text mt-18">
                                  <p style="float: left;text-align: left;
  text-justify: inter-word;">Short explaination Our goal is to create value for our clients by providing effective services. We meet their needs by combining our local market knowledge with our extensive range of skills with international.</p>
              ...
              <div class="contact-info text-center fix ptb-200 pb-15">
                            <div class="single-contact-info">
                              ...
                              <div class="col-md-10" data-aos="zoom-in-left">
                                 <h4 style="float: left">Employee Training</h4>
                                <div class="single-contact-text mt-18">
                                  <p style="float: left;text-align: left;
  text-justify: inter-word;">Short explaination Establish and professionally manage a common database to share information on the credit payment behavior of borrowers.</p>
                            ...
                            <div class="single-contact-info">
                              ...
                              <div class="col-md-10" data-aos="zoom-in">
                                 <h4 style="float: left">Employee Assistance</h4>
                            ...
                            <div class="single-contact-info">
                             <div class="col-md-2" data-aos="flip-right">
                              ...
                              <div class="col-md-10" data-aos="zoom-out-left">
                                <h4  style="float: left" >Counselling</h4>
                                <div class="single-contact-text mt-18">
                                  <p style="float: left;text-align: left;
  text-justify: inter-word;">Short explaination Our goal is to create value for our clients by providing effective services. We meet their needs by combining our .</p>
                                   <!--  <span class="block">House 09, Road 32, Mohammadpur,</span>
                                    <span class="block">Dhaka-1200, UK</span> -->
                                </div>
                            </div>
