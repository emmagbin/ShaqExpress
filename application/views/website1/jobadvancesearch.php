                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="breadcrumb-text">
                                    <h2 class="text-center text-white uppercase mb-17">job advance search</h2>
                                    <div class="breadcrumb-bar">
                                        <ul class="breadcrumb text-center m-0">
                                            ...
                                            <li class="text-white uppercase ml-15 mr-15">Job Board</li>
                                                                 ...
                                                                 <!-- <form action="" method=""> -->
                                 <form class="login-form form"  method="post" action="<?php echo base_url();?>Web/Jobs/advanceSearch">
