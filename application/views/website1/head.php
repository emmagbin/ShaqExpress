            ...
            <header class="header-area">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-5 col-md-6 col-sm-7 col-xs-12">
                                <div class="header-top-right pull-right">
                                    ...
                                    <span class="pl-30">Email: info@example.com</span>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div>
                    <div class="container">
                        <div class="row">
                            <div class="col-md-12 ">
                                <div class="logo padding text-center"><a href="index.html"><img src="<?php echo base_url(); ?>assets/website/images/logo/logo.png" alt="JobHelp"></a>
                                </div>
                            </div>
                            <div class="row" id="sticky-header">

                                <div class="col-md-12 hidden-sm hidden-xs" id="menunologo">
                                    <div class="text-center">
                                        <nav id="primary-menu">

                                            <ul class="main-menu text-right">

                                                <li><a href="<?php echo base_url('Web/index') ?>">Home</a>
                                                </li>
                                                <li><a href="<?php echo base_url('Web/jobs') ?>">Job Board</a>
                                                </li>
                                                ...
                                                <li>
                                                    <div class=" dropup wow bounceInUp  mt-35" data-wow-duration="1s" data-wow-delay="1s">
                                                        <a href="<?php echo base_url('login') ?>"> <button class="mycreatedbutton btn-primary" type="button">login</button> </a>
                                                    </div>
                                                </li>
                                            </ul>
                                        </nav>
                                ...
                                <div class="col-md-12 hidden-sm hidden-xs" style="display:none" id="myvisibility">
                                    <div class="col-md-2 hidden-sm hidden-xs">
                                        <div class="logo"><br><a href="index.html"><img src="<?php echo base_url(); ?>assets/website/images/logo/logohidden.png" alt="JobHelp"></a></div>
                                    </div>
