<div class="col-sm-8 text-right m-b-20">
    <a href="#" class="btn btn-primary rounded pull-right" data-toggle="modal" data-target="#add_department"><i class="fa fa-plus"></i> Create New fleet Doctype</a>
            ...
            <div class="card-box">
                <table id="datatable" class="table table-striped custom-table dataTable">
                    <thead>
                        <tr>
                            <th>#</th>
                            <th>Vehicle Document Type Name</th>
                            <th>Status</th>
                            <th>Created By</th>
                            <th>Created Date</th>
                    ...
                    <tbody>
                        <?php $no = 1 ?>
                        <?php foreach ($get_all_doctype as $record) : ?>

                            <tr>
                                <td><?php $no++ ?></td>
                                <td> <?php echo ($record->vehicledoctypename); ?></td>
                                <td>
                                ...
                                <td class="text-right">
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu pull-right">
                                            <li><a href="#" data-toggle="modal" class="edit_diasble_enableVehicletype" data-target="#edit_vehicletype" title="Edit" data-id="<?php echo $record->id; ?>" data-vehicletypename="<?php echo $record->vehicledoctypename; ?>"><i class="fa fa-pencil m-r-5"></i> Edit</a></li>

                                            <?php if ($record->status === "1") { ?>
                                                <li><a href="#" data-toggle="modal" class="edit_diasble_enableVehicletype" data-target="#disable_vehicletype" title="Disable" data-id="<?php echo $record->id; ?>" data-vehicletypename="<?php echo $record->vehicledoctypename; ?>"><i class="fa fa-lock m-r-5"></i> Disable</a></li>
                                            <?php } ?>

                                            <?php if ($record->status === "0") { ?>
                                                <li><a href="#" data-toggle="modal" class="edit_diasble_enableVehicletype" data-target="#enable_vehicletype" title="Enable" data-id="<?php echo $record->id; ?>" data-vehicletypename="<?php echo $record->vehicledoctypename; ?>"><i class="fa fa-unlock m-r-5"></i> Enable</a></li>
                                            <?php } ?>
        ...
        <div class="modal-content modal-md">
            <div class="card-box">
                <div class="modal-header">
                    <h4 class="modal-title">Add Fleet doctype</h4>
                </div>
                <div class="modal-body">
                    <form method="POST" action="fleetdoctype_controller/createdoctype">
                        ...
                        <div class="m-t-20 text-center">
                            <button class="btn btn-primary">Create Fleet doctype</button>
                        </div>
                    </form>
                </div>
            </div>
...
<div id="edit_vehicletype" class="modal custom-modal fade" role="dialog">
    <div class="modal-dialog">
        ...
        <div class="modal-content modal-md">
            <div class="modal-header">
                <h4 class="modal-title">Edit Fleet doctype</h4>
            </div>
            <div class="card-box">
                <div class="modal-body">
                    <form method="POST" action="fleetdoctype_controller/updatedoctype">
                        <div class="form-group">
...
<div id="enable_vehicletype" class="modal custom-modal fade" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content modal-md">
            <div class="modal-header">
                <h4 class="modal-title">Enable Fleet doctype</h4>
            </div>
            <form method="POST" action="fleetdoctype_controller/enabl_disable_doctype">
...
<div id="disable_vehicletype" class="modal custom-modal fade" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content modal-md">
            <div class="modal-header">
                <h4 class="modal-title">Disable Fleet doctype</h4>
            </div>
            <form method="POST" action="fleetdoctype_controller/enabl_disable_doctype">
                <input type="hidden" class="txtid" name="id">
