<div class="col-sm-8 text-right m-b-20">
    <a href="createinvoice" class="btn btn-primary rounded"><i class="fa fa-plus"></i> Create New Invoice</a>
        ...
        <div class="table-responsive">
            <table class="table table-striped custom-table m-b-0">
                ...
                <tbody>
                    <tr>
                        <td>1</td>
                        <td><a href="Ainvoiceview">#INV-0001</a></td>
                        ...
                        <td class="text-right">
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu pull-right">
                                    <li><a href="editinvoice"><i class="fa fa-pencil m-r-5"></i> Edit</a></li>
