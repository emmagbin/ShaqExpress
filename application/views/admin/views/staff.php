    ...
    <body>
            ...
            <div class="pcoded-container navbar-wrapper">
                ...
                <div class="pcoded-main-container">
                    <div class="pcoded-wrapper">
                        ...
                        <?php include(APPPATH . 'views/admin/staff/list.php'); ?>
                        <!-- =============================================================================================== -->
                    </div>
                </div>
            </div>
        ...
        <script>
            $(document).on('click', '#btnlock', function() {
                ...
                var id = $(this).data('users_login_id');
                ...
                swal({
                    ...
                    function() {
                        $.ajax({
                            ...
                            url: '<?php echo site_url('staff_controller/disable_member'); ?>',
                ...
                swal({
                    ...
                    function() {
                        $.ajax({
                            ...
                            url: '<?php echo site_url('staff_controller/activate_member'); ?>',
                            success: function(result) {
                                var myresult = JSON.parse(result);
                                // alert(myresult);
                                if (myresult === true) {
                ...
                swal({
                    ...
                    function() {
                        $.ajax({
                            ...
                            url: '<?php echo site_url('staff_controller/delete_member'); ?>',
                            success: function(result) {
                                var myresult = JSON.parse(result);
                ...
                swal({
                    ...
                    function() {
                        $.ajax({
                            ...
                            url: '<?php echo site_url('staff_controller/delete_jobseeker'); ?>',
                            success: function(result) {
                                var myresult = JSON.parse(result);
