            ...
            <div class="pcoded-container navbar-wrapper">
                ...
                <div class="pcoded-main-container">
                    <div class="pcoded-wrapper">
                        ...
                        <?php include(APPPATH . 'views/admin/jobs/add.php'); ?>
                        <!-- =============================================================================================== -->
                    </div>
                </div>
            </div>
                ...
                form.steps({
                    ...
                    onFinished: function(event, currentIndex) {
                        ...
                        if (JobDescription == "" || JobDescription == null) {
                            ...
                            $('.messages').html("Please Enter Job Description");
                        } else if (JobRequirement == "" || JobRequirement == null) {
                            $('.messages').html("Please Enter Job Requirement");
                        } else if (JobTitle == "" || JobTitle == null) {
                            $('.messages').html("Please Enter Job Title");
                        } else if (CompanyName == "" || CompanyName == null) {
                            $('.messages').html("Please Enter Company Name");
                        } else if (JobType == "" || JobType == null) {
                            $('.messages').html("Please Enter Job Type");
                        } else if (JobCategory == "" || JobCategory == null) {
                            $('.messages').html("Please Enter Job Category");
                        } else if (ExpectedSalary == "" || ExpectedSalary == null) {
                            $('.messages').html("Please Enter Expected Salary");
                        } else if (JobRegion == "" || JobRegion == null) {
                            $('.messages').html("Please Enter Job Region");
                        } else if (Town == "" || Town == null) {
                            $('.messages').html("Please Enter Town");
                        } else if (ApplicationStartDate == "" || ApplicationStartDate == null) {
                            $('.messages').html("Please Enter Application Start Date");
                        } else if (ApplicationClosingDate == "" || ApplicationClosingDate == null) {
                            $('.messages').html("Please Enter Application Closing Date");
                        } else {
                            // alert(creatorid);
                            ...
                            $.ajax({
                                ...
                                url: '<?php echo site_url('JobsPortal_Controller/addposition'); ?>',
