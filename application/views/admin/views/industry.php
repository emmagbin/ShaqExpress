            ...
            <div class="pcoded-container navbar-wrapper">
                ...
                <div class="pcoded-main-container">
                    <div class="pcoded-wrapper">
                        ...
                        <?php include(APPPATH . 'views/admin/industry/list.php'); ?>
                        <!-- =============================================================================================== -->
                    </div>
                </div>
            </div>
        ...
        <script>
                ...
                swal({
                    ...
                    function() {
                        $.ajax({
                            ...
                            url: '<?php echo site_url('JobIndustryController/disable_jobcategory'); ?>',
                            success: function(result) {
                                ...
                                if (myresult === true) {
                                    ...
                                    swal({
                                            title: "Locked",
                                            text: "Industry Have Successfully Been Locked.",
                                    ...
                                    swal("Locked!", "Industry Lock Failed", "error");
                                }
                            }
                        });
                    });
            ...
            $(document).on('click', '#btnunlock', function() {
                ...
                swal({
                        ...
                        showCancelButton: true,
                        confirmButtonColor: '#DD6B55',
                        confirmButtonText: 'Yes, Unlock Industry!',
                        closeOnConfirm: false,
                        //closeOnCancel: false
                    },
                    function() {
                        $.ajax({
                            ...
                            url: '<?php echo site_url('JobIndustryController/activate_jobcategory'); ?>',
                            success: function(result) {
                                var myresult = JSON.parse(result);
                                // alert(myresult);
                                if (myresult === true) {
                                    ...
                                    swal({
                                            title: "Unlocked!",
                                            text: "Industry Have Successfully Been Unlocked.",
                                            imageUrl: 'https://i.imgur.com/4NZ6uLY.jpg'
                                        },
                                        function() {
                                            location.reload();
                ...
                swal({
                    ...
                    function() {
                        $.ajax({
                            ...
                            url: '<?php echo site_url('JobIndustryController/delete_jobcategory'); ?>',
                            success: function(result) {
                                var myresult = JSON.parse(result);
                                ...
                                if (myresult === true) {
                                    ...
                                    swal({
                                            title: "Deleted!",
                                            text: "Industry Have Been Deleted Successfully.",
                                            imageUrl: 'https://i.imgur.com/4NZ6uLY.jpg'
                                        },
                                        function() {
                                            location.reload();
                                    ...
                                    swal("Delete!", "Industry Delete Failed", "error");
                                }
                            }
                        });
                    });
