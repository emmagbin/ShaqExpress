                                                 ...
                                                 <div class="col-md-11" style="padding-left: 50px; margin-top: 10px;" > 
                                                    <h4 class="mb-5"><?php echo ($record->jobtitle);?></h4>
                                                     <p class="mb-5"><?php echo ($record->companyname);?></p>
                                                      <p class="mb-5"><?php echo ($record->categoryname);?></p>
                                                       <span><?php echo ucfirst($record->locationname.' | '.$record->town.'  |  '.$record->jobtype.'  |  '.$record->expectedsalary.'  |  '.substr($record->created_at,0,10));?></span>
                                                </div>
